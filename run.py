...
import os
import torch
from exp.exp_long_term_forecast import Exp_Long_Term_Forecast # Ensure this matches your file name
...
if __name__ == '__main__':
    ...
    # =================================================================================
    # CUSTOM DATA INTERCEPTOR
    # Maps bash flags (e.g., --data vix_futures) to the exact CSVs for the dataloader
    # =================================================================================
    original_dataset_name = args.data
    custom_file_map = {
        'vix_futures': 'vix_futures.xlsx - VIX - Clean Data.csv',
        'credit_spreads': 'credit_spreads.xlsx - LUACOAS - Clean Data.csv',
        'clo_spreads': 'clo_spreads.csv',
        'bitcoin': 'bitcoin.csv',
        'spy': 'spy.csv'
    }
    ...
    if args.data in custom_file_map:
        ...
        # Most repos require 'custom' keyword to trigger the Dataset_Custom loader
        args.data = 'custom' 
    # =================================================================================
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            # Using original_dataset_name to keep your saving folders distinct
